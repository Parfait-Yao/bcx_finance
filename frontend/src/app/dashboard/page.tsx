...
export default function DashboardPage() {
  // Le tableau de bord se rafraîchit automatiquement (toutes les 15s, et
  // dès que l'onglet redevient actif) afin d'afficher le solde, le score
  // et les dernières transactions à jour sans action manuelle.
  ...
  return (
    <div className="md:pl-60 pb-20 md:pb-8">
      ...
      <main className="max-w-4xl mx-auto px-4 pt-6 space-y-6">
        ...
        {/* Carte Score BCX avec dégradé vert */}
